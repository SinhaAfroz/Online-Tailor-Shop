...
<?php
    ...
    <h1> <span class="yellow">Confirmed Orders</span></h1>
        ...
        <tbody>
            <?php
                try{
                    ...
                    $sqlquery="SELECT orders.orderno as o, orders.c_userid as c_id, orders.orderdate as orderdate, orders.deliverydate as deliverydate, orders.status as status, orders.details as details, payments.trans_no as trans_no, payments.paydate as paydate, payments.payamount as payamount FROM orders JOIN payments ON orders.orderno=payments.orderno WHERE status='Confirmed'";
                    ...
                    try{
                        ...
                        foreach($productstable as $row){
                            ?>
                                <tr>
                                    <td><button onclick="deliver(<?php echo $row['o'] ?>)">✓</button></td>
