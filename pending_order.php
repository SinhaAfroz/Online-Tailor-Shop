...
<?php
    ...
    <h1> <span class="yellow"> Pending Orders</span></h1>
        ...
        <tbody>
            <?php
                try{
                    ...
                    $sqlquery="SELECT orders.orderno as o, orders.c_userid as c_id, orders.orderdate as orderdate, orders.deliverydate as deliverydate, orders.status as status, orders.details as details, payments.trans_no as trans_no, payments.paydate as paydate, payments.payamount as payamount FROM orders JOIN payments ON orders.orderno=payments.orderno WHERE status='Pending' AND deliverydate IS NULL";
                    //echo $sqlquery;
                    ...
                    try{
                        ...
                        foreach($productstable as $row){
                            ...
                            ?>
                                ...
                                <tr>
                                    <td><button onclick='conf(<?php echo $row['o'] ?>, <?php echo $row['o'] ?>)'>✓</button>
                                    ...
                                    <td><input type="date" id='<?php echo $row['o']?>' name="<?php echo $row['o']?>" rows="10"></td>  
